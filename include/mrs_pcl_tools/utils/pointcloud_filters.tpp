...
typename std::shared_ptr<PC_t> mrs_pcl_tools::filters::applyVoxelGridFilter(ILogger& logger,
                                                                            std::shared_ptr<PC_t> const& cloud,
...
template <typename PC_t>
typename std::shared_ptr<PC_t> mrs_pcl_tools::filters::applyRadiusOutlierFilter([[maybe_unused]] ILogger& logger,
                                                                                std::shared_ptr<PC_t> const& cloud,
                                                                                const float radius, const int neighbors,
...
template <typename PC_t>
typename std::shared_ptr<PC_t> mrs_pcl_tools::filters::applyMinimumGridFilter([[maybe_unused]] ILogger& logger,
                                                                              std::shared_ptr<PC_t> const& cloud,
                                                                              const float resolution)
{
...
template <typename PC_t>
typename std::shared_ptr<PC_t> mrs_pcl_tools::filters::applyBilateralFilter(ILogger& logger,
                                                                            std::shared_ptr<PC_t> const& cloud,
